...
import edu.nuc.hcj.im.service.friendship.model.req.CheckFriendShipReq;
 ...
 * @Project : IM-system
 * @Package : edu.nuc.hcj.im.service.friendship.dao.mapper
 * @ClassName : ImFriendShipMapper.java
 * @createTime : 2023/12/7 13:43
 * @Description :
 */
@Mapper
public interface ImFriendShipMapper extends BaseMapper<ImFriendShipEntity> {
    // if(status = 1,1,0) 当状态是1的返回1 否则返回0
    @Select("<script>"+

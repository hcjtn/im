...
public class StroeGroupMessageReceiver {
    ...
    @RabbitListener(
            bindings = @QueueBinding(
                    value = @Queue(value = Constant.RabbitConstants.StoreGroupMessage,durable = "true"),
                    exchange = @Exchange(value = Constant.RabbitConstants.StoreGroupMessage,durable = "true")
            ),concurrency = "1"
    )
